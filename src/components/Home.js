...
const Home = () => {
  return (
    <div className="home">
      ...
      <div className="home_row">
        <Product title="IQOO Z9 5G (Brushed Green, 8GB RAM, 128GB Storage) | Dimensity 7200 5G Processor | Sony IMX882 OIS Camera | 120Hz AMOLED with 1800 nits Local Peak Brightness | 44W Charger in The Box" 
        price={21999}
        rating={4}
